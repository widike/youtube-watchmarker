...
export class YoutubeManager {
  ...
  async synchronize(onProgress = null) {
    try {
      ...
      logger.info(
        `YouTube sync completed: Found ${objVideos.length} total videos, ${processedCount} new added, ${skippedCount} already in database`,
      );
      return result;
    } catch (error) {
  ...
  async synchronizeLikedVideos(onProgress = null) {
    try {
      ...
      logger.info(
        `Liked videos sync completed: Found ${objVideos.length} total videos, ${processedCount} new added, ${skippedCount} already in database`,
      );
      return result;
    } catch (error) {
